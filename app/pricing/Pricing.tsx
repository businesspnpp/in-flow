...
export default function PremiumPricingPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-white text-zinc-900 selection:bg-[#795bf4]/15 selection:text-[#4c35bc] font-sans antialiased">
      
      {/* Premium Header */}
      <header className="w-full border-b border-zinc-200/80 bg-white/95 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login?mode=signup" className="text-sm font-bold px-5 py-2.5 rounded-lg bg-[#795bf4] text-white hover:bg-[#6847ef] transition-colors shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
              Get Started Free
            </Link>
          </div>
        </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 pt-10 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 text-left space-y-6">
          ...
          <div className="inline-flex items-center p-1.5 bg-zinc-50 rounded-lg border border-zinc-200 mt-4 shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
            <button
        ...
        <div className="lg:col-span-5 bg-zinc-50 rounded-xl border border-zinc-200 shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-8 space-y-6">
          <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
            <h3 className="font-bold text-base tracking-tight text-zinc-900 flex items-center gap-2">
              <TrendingUp size={18} strokeWidth={1.5} className="text-zinc-700" /> Plan Matcher Estimate
            </h3>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm font-bold">
              ...
              <span className="text-zinc-900 text-base font-black">{estimatedConversations === 1500 ? '1,500+' : estimatedConversations}</span>
            </div>
            <input 
              type="range" 
              min="10" 
          ...
          <div className="bg-white p-4 rounded-lg border border-zinc-200 flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-2xl font-black text-zinc-900">{suggestedPlan.cost}</p>
      ...
      <section className="w-full max-w-[88rem] mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 gap-4 items-stretch md:grid-cols-2 lg:grid-cols-4 lg:gap-4">
          {tiers.map((tier, index) => {
            ...
            return (
              <div
                key={tier.name}
                className={`flex flex-col min-w-0 p-8 rounded-xl border transition-colors duration-200 relative shadow-[0_1px_3px_rgba(0,0,0,0.08)] ${cardSpacing} ${
                  tier.highlighted 
                    ? 'border-[#795bf4] bg-[#795bf4]/8' 
                    : tier.darkVariant
              ...
              >
                {tier.highlighted && (
                  <span className="absolute -top-3.5 left-6 rounded-lg bg-[#795bf4] text-white text-[10px] font-black px-3 py-1 tracking-widest uppercase border border-[#6847ef]">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className={`shrink-0 rounded-lg text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 border ${
                    tier.darkVariant 
                ...
                <div className="mt-8">
                  <Link
                    ...
                    className={`w-full block text-center px-5 py-3.5 text-sm font-bold tracking-tight transform active:scale-[0.99] transition-all rounded-lg ${
                      tier.highlighted
      ...
      <section className="w-full max-w-7xl mx-auto px-6 pb-20">
        <div className="bg-zinc-950 text-white p-10 md:p-12 rounded-xl border border-zinc-800 shadow-[0_1px_3px_rgba(0,0,0,0.2)] relative overflow-hidden">
          ...
          <div className="max-w-3xl">
            <span className="rounded-lg text-[11px] font-black tracking-widest text-[#c7bbff] uppercase bg-[#8d73f6]/10 border border-[#795bf4]/20 px-2.5 py-1">
      ...
      <section className="w-full max-w-7xl mx-auto px-6 pb-24">
        <div className="rounded-xl border border-[#6e54d9] bg-gradient-to-br from-[#9e8af8] via-[#8d73f6] to-[#795bf4] p-10 md:p-16 text-center shadow-[0_1px_3px_rgba(0,0,0,0.12)] relative overflow-hidden">
