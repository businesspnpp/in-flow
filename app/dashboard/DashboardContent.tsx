  ...
  return (
    <div className="h-[100dvh] w-full overflow-hidden flex flex-col bg-white">
      ...
      <header className="flex-shrink-0 border-b border-zinc-200 bg-white">
        ...
        <div className="px-4 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {" "}
            <div className="hidden md:flex bg-emerald-50 px-4 py-1 text-xs font-semibold text-emerald-700">
              {" "}
              Authenticated{" "}
            </div>{" "}
            <button
              ...
              className="flex items-center gap-2 bg-red-600 hover:bg-red-700 px-4 py-1.5 text-xs font-semibold text-white transition disabled:opacity-50"
              title="Sign out"
            >
              {" "}
        ...
        <div className="border-t border-zinc-100 overflow-x-auto scrollbar-none px-4 py-3.5">
          {" "}
          <div className="flex gap-2 whitespace-nowrap">
            ...
            {TOOL_ACTIONS.map((tool) => (
              <button
                ...
                className="flex-shrink-0 inline-flex items-center bg-zinc-100 px-4 py-2.5 text-xs font-semibold text-zinc-900 transition hover:bg-zinc-200"
              >
                {" "}
                {tool.label}{" "}
              </button>
      ...
      <main className="flex-1 overflow-hidden pb-16 md:pb-0">
        ...
        {globalTab === "chats" && (
          <div className="h-full w-full overflow-hidden">
            {" "}
            {!showThread ? (
              /* Chats List */ <div className="flex flex-col h-full overflow-hidden">
                {" "}
                ...
                <div className="flex-1 overflow-y-auto px-4 py-3.5">
                  ...
                  <button
                    ...
                    className="w-full border border-zinc-200 bg-white px-4 py-4 text-left transition hover:bg-zinc-50"
                  >
                    {" "}
                    <div className="flex items-center gap-3">
                      {" "}
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="truncate text-xs text-zinc-500">
                          WhatsApp Business • Consultation request
                        </p>{" "}
                      </div>{" "}
                    </div>{" "}
                  </button>{" "}
              ...
              /* Conversation Thread */ <div className="flex flex-col h-full overflow-hidden">
                {" "}
                <div className="flex-shrink-0 px-4 py-3.5 border-b border-zinc-200 bg-white flex items-center gap-3">
                  {" "}
                  <button
                    onClick={() => setShowThread(false)}
                    className=" border border-zinc-200 p-2 text-zinc-900 transition hover:bg-zinc-100 md:hidden"
                  >
                    {" "}
                ...
                <div className="flex-shrink-0 border-t border-zinc-200 bg-white px-4 py-4">
                  {" "}
                  <div className="flex flex-row items-center justify-between w-full gap-2 px-4 py-2.5 bg-gray-50 border border-gray-200 ">
                    {" "}
                    <input
                      value={input}
        ...
        {globalTab === "tools" && (
          <div className="h-full overflow-y-auto px-4 py-6">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-1 text-xs text-zinc-500">
                Administrative workspace for quick actions.
              </p>{" "}
        ...
        {globalTab === "settings" && (
          <div className="h-full overflow-y-auto px-4 py-6">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-1 text-xs text-zinc-500">
                Omni-channel integrations and connection status.
              </p>{" "}
              <div className="mt-6 space-y-3">
                ...
                {CHANNELS.map((channel) => (
                  <div
                    key={channel.id}
                    className={` border px-6 py-4 ${channel.isActive ? "border-zinc-200 bg-white" : "border-zinc-100 bg-zinc-50"}`}
                  >
                    {" "}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-zinc-200 bg-white md:static">
        {" "}
        <div className="flex items-center justify-around px-4 py-3.5 md:justify-start md:gap-2">
          {" "}
          <button
            onClick={() => {
              setGlobalTab("chats");
