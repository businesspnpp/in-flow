...
export default function Auth({ onSignedIn, onSignedOut }: AuthProps) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#121214] px-4 scrollbar-hide">
      <style>{`
        .scrollbar-hide {
      ...
      {user && (
        <div className="w-full max-w-md border border-zinc-800 bg-[#16161a] p-8 rounded-2xl shadow-xl">
          <div className="mb-6">
