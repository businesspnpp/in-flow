  ...
  return (
    <div className="flex flex-col h-full w-full bg-white border-r border-zinc-200">
      ...
      <div className="p-3 border-b border-zinc-200">
        <div className="flex items-center gap-2 bg-zinc-50 border border-zinc-200 px-3 py-2 w-full">
        ...
        {filtered.map((chat) => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 border-b border-zinc-100 hover:bg-zinc-50 transition-colors text-left ${
              activeChat?.id === chat.id ? 'bg-zinc-50 border-l-2 border-l-amber-600' : ''
            }`}
          >
